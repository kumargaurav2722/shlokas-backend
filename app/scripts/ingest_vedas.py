...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Ingest Vedic verses into texts table")
    ...
    parser.add_argument("--category", default="veda")
    parser.add_argument("--work", default="Rigveda")
    parser.add_argument("--sub-work", default="Mandala 1", dest="sub_work")
