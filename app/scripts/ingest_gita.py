...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Ingest Bhagavad Gita verses into texts table")
    ...
    parser.add_argument("--work", default="Mahabharata")
    parser.add_argument("--sub-work", default="Bhagavad Gita", dest="sub_work")
    parser.add_argument("--source", default="Gita Press")
